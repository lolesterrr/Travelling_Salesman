...
#The SOM is a type of artificial neural network that is trained using unsupervised learning to produce a low-dimensional representation of the input space
import random
...
print("\nSOM Approximate TSP Path:", route)
